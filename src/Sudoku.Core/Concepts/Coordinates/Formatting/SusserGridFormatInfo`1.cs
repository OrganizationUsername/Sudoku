...
public partial class SusserGridFormatInfo<TGrid> : GridFormatInfo<TGrid> where TGrid : unmanaged, IInlineArrayGrid<TGrid>
{
	/// <summary>
	...
	public sealed override IFormatProvider? GetFormat(Type? formatType) => formatType == typeof(GridFormatInfo<TGrid>) ? this : null;

	/// <inheritdoc/>
	public sealed override SusserGridFormatInfo<TGrid> Clone()
		=> new()
		{
	...
	/// <inheritdoc/>
	protected internal sealed override TGrid ParseCore(string str)
	{
		if (IsCompatibleMode)
		{
