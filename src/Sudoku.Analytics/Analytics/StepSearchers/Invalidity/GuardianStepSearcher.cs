...
/// </list>
/// </summary>
[StepSearcher("StepSearcherName_GuardianStepSearcher", Technique.BrokenWing)]
public sealed partial class GuardianStepSearcher : StepSearcher
{
	...
	protected internal override Step? Collect(ref StepAnalysisContext context)
	{
		...
		var playground = grid;
		var pomContext = new StepAnalysisContext(playground) { Accumulator = pomSteps, OnlyFindOne = false, Options = context.Options };
