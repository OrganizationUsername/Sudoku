...
public sealed partial class ComplexSingleStepSearcher : StepSearcher
{
	...
	protected internal override Step? Collect(ref StepAnalysisContext context)
	{
		...
		)
		{
			...
			var tempContext = new StepAnalysisContext(in grid)
			{
			...
			{
				foreach (var indirectSteps in indirectFoundSteps.AsSpan() & applyingSize)
				{
				...
				ValidityCheck:
					...
					var nestedContext = new StepAnalysisContext(in playground)
					{
