...
public sealed partial class XyzRingStepSearcher : StepSearcher
{
	...
	private void CollectCore(HashSet<XyzRingStep> accumulator, in Grid grid, ref readonly StepAnalysisContext context)
	{
		...
		foreach (var (pivot, leafCell1, leafCell2, house1, house2, unionDigitsMask, zDigit) in new XyzWingPatternSearcher().Search(grid))
		{
			...
			var theOtherDigit1 = BitOperations.PopTwo((uint)theOtherTwoDigitsMask, out var theOtherDigit2);
