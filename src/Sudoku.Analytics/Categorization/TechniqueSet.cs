...
{
	/// <summary>
	/// Indicates the information for the techniques, can look up the relation via its belonging technique group.
...
/// <summary>
/// Represents JSON serialization rules on type <see cref="TechniqueSet"/>.
/// </summary>
file sealed class Converter : JsonConverter<TechniqueSet>
{
	...
	{
		var (result, isInitialized) = (TechniqueSet.None, false);
		while (reader.Read())
		{
