...
## 三数淑芬致命结构在四格里的用法 <a href="#special-case-three-digits-in-four-cells" id="special-case-three-digits-in-four-cells"></a>

三数淑芬致命结构的出现频次不太高，可遇不可求。所以我们也时常有下面这种用法。

<figure><img src="../../.gitbook/assets/images_1057.png" alt="" width="375"><figcaption><p>其他用法</p></figcaption></figure>

如图所示。可以看到，`c56` 和 `r78c8` 差不多快构成一个淑芬致命结构了，不过还差一点，因为 `r89c4` 这里还有 1。

本题稍微按强制链的思路去分析。考虑 `r3` 上的所有 5。当 5 填入在 `r3c34` 的任意一个单元格里，都会造成 `r8c34` 和 `r9c4` 这三个单元格里出 1，于是 `r8c56 <> 1` 此时成立。

<figure><img src="../../.gitbook/assets/images_1058.png" alt=""><figcaption><p>r3c34 填 5 的两种情况</p></figcaption></figure>
