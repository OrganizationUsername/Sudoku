...
/// <seealso href="http://forum.enjoysudoku.com/uniqueness-clue-cover-t40814.html#p342974">Serg's Description to UCC</seealso>
[StepSearcher(
...
public sealed partial class UniquenessClueCoverStepSearcher : StepSearcher
{
	...
	protected internal override Step? Collect(ref StepAnalysisContext context)
	{
		...
		foreach (var (chuteIndex, isRow, _) in Chute.Chutes)
		{
			ref readonly var chute = ref Chute.ChuteMaps[chuteIndex];
			...
			var step = new UniquenessClueCoverStep(
				...
				[
					[
						new ChuteViewNode(ColorIdentifierAlias.Normal, chuteIndex),
						new CellViewNode(ColorIdentifierAlias.Normal, c1),
						new CellViewNode(ColorIdentifierAlias.Normal, c2)
					]
				],
				context.Options,
				c1.AsCellMap() + c2,
