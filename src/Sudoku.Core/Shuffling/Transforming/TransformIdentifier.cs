	...
	IEqualityOperators<TransformIdentifier, TransformIdentifier, bool>
{
	...
	/// Shuffle inner lines.
	/// </summary>
	/// <param name="indices">The indices of 3 values.</param>
	/// <param name="i">The index in range [0, 6).</param>
	private static void ShuffleInnerLines(Span<int> indices, int i)
	{
		switch (i)
		{
			case 1:
			{
				Unsafe.Swap(ref indices[1], ref indices[2]); // 132
				break;
			}
			case 2:
			{
				Unsafe.Swap(ref indices[0], ref indices[1]); // 213
				break;
			}
			case 3:
			{
				Unsafe.Swap(ref indices[0], ref indices[1]); // 213
				Unsafe.Swap(ref indices[1], ref indices[2]); // 231
				break;
			}
			case 4:
			{
				Unsafe.Swap(ref indices[0], ref indices[2]); // 321
				Unsafe.Swap(ref indices[1], ref indices[2]); // 312
				break;
			}
			case 5:
			{
	...
	/// <param name="indices">The indices of 3 values.</param>
	/// <param name="i">The index in range [0, 6).</param>
	private static void ShuffleOuterlines(Span<int> indices, int i)
	{
		switch (i)
		{
			case 1:
			{
				Unsafe.Swap(ref indices[3], ref indices[6]);
				Unsafe.Swap(ref indices[4], ref indices[7]);
				Unsafe.Swap(ref indices[5], ref indices[8]);
				break;
			}
			case 2:
			{
				Unsafe.Swap(ref indices[0], ref indices[3]);
				Unsafe.Swap(ref indices[1], ref indices[4]);
				Unsafe.Swap(ref indices[2], ref indices[5]);
				break;
			}
			case 3:
			{
			...
			case 4:
			{
				Unsafe.Swap(ref indices[0], ref indices[6]);
				Unsafe.Swap(ref indices[1], ref indices[7]);
				Unsafe.Swap(ref indices[2], ref indices[8]);
				Unsafe.Swap(ref indices[3], ref indices[6]);
				Unsafe.Swap(ref indices[4], ref indices[7]);
				Unsafe.Swap(ref indices[5], ref indices[8]);
				break;
