...
public readonly struct ValueColorIdentifier(long mask) :
	IEquatable<ValueColorIdentifier>,
	IEqualityOperators<ValueColorIdentifier, ValueColorIdentifier, bool>,
	ITuple
{
	/// <summary>
	...
	/// <summary>
	/// Initializes a <see cref="ValueColorIdentifier"/> instance via the specified an integer ID.
	/// </summary>
	/// <param name="id">The ID value.</param>
	public ValueColorIdentifier(int id) : this((long)ColorIdentifierType.Alias << TypeShift | (long)id)
	{
	}

	/// <summary>
	/// Initializes a <see cref="ValueColorIdentifier"/> instance via ARGB values.
	/// </summary>
	/// <param name="a">The alpha value.</param>
	/// <param name="r">The red value.</param>
	/// <param name="g">The green value.</param>
	/// <param name="b">The blue value.</param>
	public ValueColorIdentifier(byte a, byte r, byte g, byte b) :
		this((long)ColorIdentifierType.Argb << TypeShift | (long)(a << 24 | r << 16 | g << 8 | b))
	{
	}

	/// <summary>
	/// Initializes a <see cref="ValueColorIdentifier"/> instance via well-known item.
	/// </summary>
	/// <param name="item">The well-known item.</param>
	public ValueColorIdentifier(ColorIdentifierAlias item) : this((long)ColorIdentifierType.Alias << TypeShift | (long)item)
	{
	}
	...
	/// </summary>
	public long ValueMask => Mask & (1 << TypeShift) - 1;
	...
	/// <inheritdoc/>
	public override bool Equals([NotNullWhen(true)] object? obj) => obj is ValueColorIdentifier comparer && Equals(comparer);

	/// <inheritdoc/>
	public bool Equals(ValueColorIdentifier other) => Mask == other.Mask;
	...
	/// <inheritdoc/>
	public static bool operator ==(ValueColorIdentifier left, ValueColorIdentifier right) => left.Equals(right);

	/// <inheritdoc/>
	public static bool operator !=(ValueColorIdentifier left, ValueColorIdentifier right) => !(left == right);


	/// <summary>
	/// Implicit cast from <see cref="int"/> to <see cref="ValueColorIdentifier"/>.
	/// </summary>
	/// <param name="id">The ID.</param>
	public static implicit operator ValueColorIdentifier(int id) => new(id);

	/// <summary>
	/// Implicit cast from (<see cref="byte"/>, <see cref="byte"/>, <see cref="byte"/>, <see cref="byte"/>)
	/// to <see cref="ValueColorIdentifier"/>.
	/// </summary>
	/// <param name="tuple">The tuple or ARGB values.</param>
	public static implicit operator ValueColorIdentifier((byte Alpha, byte Red, byte Green, byte Blue) tuple)
		=> new(tuple.Alpha, tuple.Red, tuple.Green, tuple.Blue);

	/// <summary>
	/// Implicit cast from <see cref="ColorIdentifierAlias"/> to <see cref="ValueColorIdentifier"/>.
	/// </summary>
	/// <param name="item">The aliased item.</param>
	public static implicit operator ValueColorIdentifier(ColorIdentifierAlias item) => new(item);
}

/// <summary>
/// Represents a JSON converter that can serialize and deserialize with instances of this type.
/// </summary>
file sealed class Converter : JsonConverter<ValueColorIdentifier>
{
	/// <summary>
	...
	/// <inheritdoc/>
	public override ValueColorIdentifier Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
	...
	/// <inheritdoc/>
	public override void Write(Utf8JsonWriter writer, ValueColorIdentifier value, JsonSerializerOptions options)
	{
		switch (value.Type)
		{
