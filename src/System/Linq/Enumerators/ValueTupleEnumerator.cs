...
public ref struct ValueTupleEnumerator<T> : IEnumerator<T>
{
	...
	public ValueTupleEnumerator(scoped in (T, T) pair)
	{
	...
	public ValueTupleEnumerator(scoped in (T, T, T) triple)
	{
	...
	public ValueTupleEnumerator(scoped in (T, T, T, T) quadruple)
	{
	...
	public ValueTupleEnumerator(scoped in (T, T, T, T, T) quintuple)
	{
	...
	public ValueTupleEnumerator(scoped in (T, T, T, T, T, T) sextuple)
	{
	...
	public ValueTupleEnumerator(scoped in (T, T, T, T, T, T, T) septuple)
	{
