...
public sealed class AlmostLockedSetsChainingRule : ChainingRule
{
	...
	{
		var alsIndex = processedViewNodesMap.MaxKeyInAlmostLockedSet is var key and not ColorIdentifierAlias.Normal
			? (key - ColorIdentifierAlias.AlmostLockedSet1 + 1) % 5
			: 0;
		...
		foreach (var link in pattern.Links)
		{
			...
			var id = alsIndex + ColorIdentifierAlias.AlmostLockedSet1;
			foreach (var cell in cells)
			{
