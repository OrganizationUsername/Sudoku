...
如图所示。这个题一共有 5 个强区域和 7 个弱区域。和刚才一样，数字 3 形成了自减，所以虽然标了 4 个弱区域，但实际只能填两次：其他的数字 1、5、7 则刚好最多都只能放一个，所以安排下来，3 必须填入两个才行。
...
小舟之前在贴吧里写了几篇关于秩理论的讨论和推算的帖子，其中有一篇跟本文有关系。教程下一篇会继续探讨秩的计算规则和一些复杂结构的常见属性特征等等。之后也会在适合的时候给出帖子的链接。
