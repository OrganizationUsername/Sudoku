...
public enum Technique
{
	...
	/// <summary>
	/// Indicates broken loop type 2.
	/// </summary>
	[TechniqueMetadata<BrokenLoopStepSearcher, BrokenLoopType2Step>(
		Rating = 53,
		DifficultyLevel = DifficultyLevel.Fiendish,
		ContainingGroup = TechniqueGroup.BrokenLoop)]
	BrokenLoopType2,
	...
	/// <summary>
	/// Indicates broken loop type 3.
	/// </summary>
	[TechniqueMetadata<BrokenLoopStepSearcher, BrokenLoopType3Step>(
		Rating = 51,
		DifficultyLevel = DifficultyLevel.Fiendish,
		ContainingGroup = TechniqueGroup.BrokenLoop)]
	BrokenLoopType3,
