...
/// </summary>
public sealed class DancingLinksSolver : ISolutionEnumerableSolver<DancingLinksSolver>
{
	/// <summary>
	...
	/// <inheritdoc/>
	public event EventHandler<DancingLinksSolver, SolverSolutionFoundEventArgs>? SolutionFound;
