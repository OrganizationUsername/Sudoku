...
请注意。`r1c9(6)` 是另外一个情况（毛刺为假）里构造出来的解鱼结构的删数的其中一个。我们之前说过一点，当毛刺为假时形成的删数我们称为预备删数，这些删数不能直接删去，因为它只是毛刺为假的情况才能造成的删数结论。但是，当毛刺为真的时候，如果我们能有一条链可以得到预备删数为真的情况，则说明什么？说明它绽放了。
